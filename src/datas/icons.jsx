    ...
    sections: [
      {
        ...
        items: [
          ...
          { id: "lehoi", name: "Lễ hội", icon: <Flag size={22} />, path: "/admin/content/lehoi" },
          { id: "mungtho", name: "Mừng thọ", icon: <Award size={22} />, path: "/admin/content/mungtho" },
          { id: "yearendparty", name: "Year End Party", icon: <GlassWater size={22} />, path: "/admin/content/yearendparty" },
