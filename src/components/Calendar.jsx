        ...
        <div className="cal-modal-overlay">
          <div className="cal-modal-content">
            <div className="cal-modal-header">
              <h3>{editingBooking ? 'Cập nhật lịch Booking' : 'Thêm lịch Booking mới'}</h3>
              <button className="cal-close-btn" onClick={() => setShowModal(false)}>
                <X size={18} />
              </button>
            </div>
            <form onSubmit={handleSaveBooking} className="cal-form">
              ...
              <div className="cal-form-group">
                ...
                <input 
                  ...
                  placeholder="Ví dụ: 13001500 -> 13:00 - 15:00"
                  maxLength={13}
                />
              </div>
              ...
              <div className="cal-form-group">
                <label>Nhân sự còn lại:</label>
                <div style={{ display: 'flex', gap: '15px', marginTop: '6px' }}>
                  {['Hết', 'Ít', 'Nhiều'].map((opt) => (
                    <label key={opt} style={{ display: 'flex', alignItems: 'center', gap: '6px', cursor: 'pointer', fontWeight: 'normal' }}>
                      <input 
                        type="radio" 
                        name="staff_note_radio" 
                        value={opt} 
                        checked={formData.staff_note === opt} 
              ...
              <div className="cal-modal-buttons">
                <button type="submit" className="cal-btn-save" style={{ width: '100%' }}>Lưu thông tin</button>
              </div>
            </form>
          </div>
        </div>
